    ...
    "registration_questions": [
        {
            "index": 1,
            "question": {
                "text": "Здравствуйте! Я ваш голосовой помощник и специалист по головной боли. Мы начнем процесс регистрации. Произнесите голосом (либо напишите текстовым сообщением) вашу Фамилию, Имя и дату рождения (число, месяц, год)",
                "options": [],
    ...
    "daily_questions": [
        {
            "index": 1,
            "question": {
                "text": "Здравствуйте! Я ваш голосовой помощник и специалист по головной боли. Начнем ежедневный опрос. Пожалуйста, произнесите голосом или напишите текстовым сообщением ваш ответ на мой вопрос: У вас сегодня болела голова и если ответ положительный, то принимали ли вы какие-либо медикаменты для купирования приступа головной боли и какие, если принимали?",
                "options": [
                    "Не болела",
                    "Болела, не принимал",
                    "Болела, принимал",
